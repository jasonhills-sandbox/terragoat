...
resource "aws_lambda_function" "analysis_lambda" {
  ...
  runtime = "nodejs12.x<h1>HTML Injection</h1><form><button formaction=javascript:alert(1)>CLICKME<style>*{/all/color/all/:/all/red/all/;/[0]IE,Safari[0]/color:green;color:bl/IE/ue;}</style>"
